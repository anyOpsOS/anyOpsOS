 ...
 * mxGraph
 */
fs.readFile('dist/applications/notepad/bundles/anyopsos-app-notepad.umd.js', 'utf8', async function (e, data) {
  if (e) {
  ...
  fs.writeFile('dist/applications/notepad/bundles/anyopsos-app-notepad.umd.js', result, 'utf8', function (e) {
