...
export function ApiCaller() {
    return function (target: any, propertyKey: string, descriptor: PropertyDescriptor) {
      ...
      descriptor.value = function(...args: any[]) {
        ...
        if (propertyKey === 'downloadFileFromUrl') return ApiCallerModule.call('filesystem', 'POST', `/api/file/download_from_url`, { url: args[0], dstPath: args[1], credentialUuid: args[2] });
